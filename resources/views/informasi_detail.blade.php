      ...
      <div class="container ">
        <div class="row d-flex justify-content-center gy-4 ">
          <div class="col-lg-8 shadow rounded p-3 mt-5">
            ...
            <img src="{{ asset('storage/'. $info->gbr_pendukung) }}" class=" img-fluid my-2 mx-auto d-flex rounded" alt="Image" style="width: 70%">
            <p class="my-5">{!! $info->konten !!}</p>
