                ...
                <h2 class="text-center">Tambah Informasi</h2>
                    <form method="post" action="{{ route('admin.informasi.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" type="text" name="slug" id="slug" value="{{ old('slug') }}"  readonly>
                        </div>
                    ...
                    <button type="submit" class="btn btn-primary float-right">Tambah Informasi</button>
                    </form>
            </div>
        </div>
    </div>
